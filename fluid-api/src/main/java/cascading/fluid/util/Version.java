...
public class Version
  ...
  public static final String FLUID_RELEASE_MAJOR = "fluid.release.major";
  public static final String FLUID_RELEASE_MINOR = "fluid.release.minor";
  public static final String FLUID_BUILD_NUMBER = "fluid.build.number";
  ...
  public static String getBannerVersionString()
    {
    return String.format( "Concurrent, Inc - %s %s", FLUID, getFullVersionString() );
    }
  ...
  public static String getReleaseBuild()
    {
    return getVersionProperties().getProperty( FLUID_BUILD_NUMBER );
    }

  public static String getReleaseMinor()
    {
    return getVersionProperties().getProperty( FLUID_RELEASE_MINOR );
    }

  public static String getReleaseMajor()
    {
    return getVersionProperties().getProperty( FLUID_RELEASE_MAJOR );
    }
  ...
  public static Properties loadVersionProperties() throws IOException
    ...
    InputStream stream = Version.class.getClassLoader().getResourceAsStream( "cascading/fluid/version.properties" );
    ...
    stream = Version.class.getClassLoader().getResourceAsStream( "cascading/fluid/build.number.properties" );
